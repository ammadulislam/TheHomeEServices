...
<head>
 ...
 function handleLinkClick(row, action) {
            selectedRowData = {
                ...
                power_solution: row.cells[5].innerText,
                roof_shade: row.cells[6].innerText,
                monthly_electric_bill: row.cells[7].innerText,
                property_type: row.cells[8].innerText,
                
                address: row.cells[9].innerText,
                state: row.cells[10].innerText,
                zipcode: row.cells[11].innerText,
                phone_number: row.cells[12].innerText,
                email: row.cells[13].innerText,
                universal_leadid: row.cells[14].innerText,
                trusted_form: row.cells[15].innerText
            };
        ...
        <table id="dataTable" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                foreach ($cursor as $document) {
                    ...
                    echo "<td>" . htmlspecialchars($document['power_solution']) . "</td>";
                    echo "<td>" . htmlspecialchars($document['roof_shade']) . "</td>";
                    echo "<td>" . htmlspecialchars($document['monthly_electric_bill']) . "</td>";
                    echo "<td>" . htmlspecialchars($document['property_type']) . "</td>";
                    ...
                    echo "<td><a href='#' onclick=\"handleLinkClick1(this.parentNode.parentNode, 'Ping')\">Ping</a></td>";
