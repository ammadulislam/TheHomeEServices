...
<head>
 ...
 function handleLinkClick(row, action) {
            selectedRowData = {
                ...
                roof_type: row.cells[5].innerText,
                project_nature: row.cells[6].innerText,
                property_type: row.cells[7].innerText,
                address: row.cells[8].innerText,
            ...
            if (action === 'D1') {
                ...
                selectedRowData.affiliate_id = '1713792565';
               ...
               // selectedRowData.landing_page_url: 'thehomeeservices.com';
                ...
                selectedRowData.traffic_source_id = 1713792565;
        ...
        <table id="dataTable" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                foreach ($cursor as $document) {
                    ...
                    echo "<td>" . htmlspecialchars($document['roof_type']) . "</td>";
