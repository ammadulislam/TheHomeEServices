...
<head>
 ...
 function handleLinkClick(row, action) {
            selectedRowData = {
                ...
                kitchen_type: row.cells[5].innerText,
                removing_adding_walls: row.cells[6].innerText,
            ...
            if (action === 'D1') {
                ...
                selectedRowData.affiliate_id = '1713793646';
        ...
        <table id="dataTable" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                foreach ($cursor as $document) {
                    ...
                    echo "<td>" . htmlspecialchars($document['kitchen_type']) . "</td>";
                    echo "<td>" . htmlspecialchars($document['removing_adding_walls']) . "</td>";
