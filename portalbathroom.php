...
<head>
 ...
 function handleLinkClick(row, action) {
            selectedRowData = {
                ...
                bathroomtype: row.cells[5].innerText,
            ...
            if (action === 'D1') {
                ...
                selectedRowData.affiliate_id = '1713793437';
        ...
        <table id="dataTable" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                foreach ($cursor as $document) {
                    ...
                    echo "<td>" . htmlspecialchars($document['bathroomtype']) . "</td>";
